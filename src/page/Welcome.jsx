            ...
            <div className="h-[40vh] lg:h-[80vh] bg-bglight dark:bg-bgdark mt-4 lg:mt-[6rem]">
                <div className="h-[40vh]  px-[2rem] lg:px-[2rem] xl:px-[10rem] flex flex-col lg:flex-row lg:items-center  gap-2 lg:gap-0  justify-between">
                    <div className="flex flex-col gap-4">
                        <p className='dark:text-greenyellow text-blue-500'>Created by Duy Thanh Lieu</p>
                                ...
                                <div className="info flex justify-between">
                                    <div className="flex items-center gap-2 ">
                                        ...
                                        <div className="bg-bgmlight dark:bg-bgmdark p-0 rounded-lg flex flex-col gap-3">
                                            ...
                                            <p className='text-black dark:text-white flex items-center gap-2'>Duy Thanh Lieu  <span className='dot w-1 h-1 rounded-full dark:bg-greenyellow bg-blue-500'></span> <span className='dark:text-greenyellow text-blue-500 text-sm'> 12h ago</span> </p>
                                        </div>
                                    </div>
